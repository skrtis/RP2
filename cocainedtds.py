...
cIV_rsum[1].plot(x_mid,y_mid,'b.',markersize=10)
cIV_rsum[1].bar(x_mid,y_mid,width=0.03,alpha=0.5,edgecolor='k')
...
cIV_rsum[2].plot(cIVx_right,cIVy_right,c='r')
cIV_rsum[2].bar(cIVx_right,cIVy_right,width=0.03,alpha=0.5,align='edge',edgecolor='k')

plt.show()

# write all code as functions and methods.
